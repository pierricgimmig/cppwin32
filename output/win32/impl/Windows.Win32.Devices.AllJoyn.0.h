...
#ifndef WIN32_Windows_Win32_Devices_AllJoyn_0_H
#define WIN32_Windows_Win32_Devices_AllJoyn_0_H
...
#pragma region enums
    ...
    enum class alljoyn_about_announceflag : int32_t
    {
        UNANNOUNCED = 0,
        ANNOUNCED = 1,
    };
    enum class alljoyn_applicationstate : int32_t
    {
        NOT_CLAIMABLE = 0,
        CLAIMABLE = 1,
        CLAIMED = 2,
    ...
    enum class alljoyn_claimcapability_masks : int32_t
    {
        CAPABLE_ECDHE_NULL = 1,
        CAPABLE_ECDHE_ECDSA = 4,
        CAPABLE_ECDHE_SPEKE = 8,
    };
    enum class alljoyn_claimcapabilityadditionalinfo_masks : int32_t
    {
        PASSWORD_GENERATED_BY_SECURITY_MANAGER = 1,
        PASSWORD_GENERATED_BY_APPLICATION = 2,
    };
    enum class alljoyn_interfacedescription_securitypolicy : int32_t
    {
        AJ_IFC_SECURITY_INHERIT = 0,
        AJ_IFC_SECURITY_REQUIRED = 1,
        AJ_IFC_SECURITY_OFF = 2,
    };
    enum class alljoyn_messagetype : int32_t
    {
    ...
    enum class alljoyn_sessionlostreason : int32_t
    {
    ...
    enum class alljoyn_typeid : int32_t
    {
        ALLJOYN_INVALID = 0,
        ALLJOYN_ARRAY = 97,
        ALLJOYN_BOOLEAN = 98,
...
#pragma region forward_declarations
    ...
    struct alljoyn_observer;
    struct alljoyn_observerlistener;
    struct alljoyn_observerlistener_callback;
    struct alljoyn_permissionconfigurationlistener;
    struct alljoyn_permissionconfigurationlistener_callbacks;
    struct alljoyn_permissionconfigurator;
    struct alljoyn_pinglistener;
    struct alljoyn_pinglistener_callback;
    struct alljoyn_proxybusobject;
    struct alljoyn_proxybusobject_ref;
    struct alljoyn_securityapplicationproxy;
    struct alljoyn_sessionlistener;
    struct alljoyn_sessionlistener_callbacks;
    struct alljoyn_sessionopts;
    struct alljoyn_sessionportlistener;
    struct alljoyn_sessionportlistener_callbacks;
#pragma endregion forward_declarations

#pragma region delegates
    using alljoyn_applicationstatelistener_state_ptr = void __stdcall(int8_t*, int8_t*, Windows::Win32::Devices::AllJoyn::alljoyn_applicationstate, void*);
    using alljoyn_keystorelistener_loadrequest_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_keystorelistener, Windows::Win32::Devices::AllJoyn::alljoyn_keystore);
    using alljoyn_keystorelistener_storerequest_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_keystorelistener, Windows::Win32::Devices::AllJoyn::alljoyn_keystore);
    using alljoyn_keystorelistener_acquireexclusivelock_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_keystorelistener);
    using alljoyn_keystorelistener_releaseexclusivelock_ptr = void __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_keystorelistener);
    using alljoyn_authlistener_requestcredentials_ptr = int32_t __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, uint16_t, Windows::Win32::Foundation::PSTR, uint16_t, Windows::Win32::Devices::AllJoyn::alljoyn_credentials);
    using alljoyn_authlistener_requestcredentialsasync_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_authlistener, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, uint16_t, Windows::Win32::Foundation::PSTR, uint16_t, void*);
    using alljoyn_authlistener_verifycredentials_ptr = int32_t __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_credentials);
    using alljoyn_authlistener_verifycredentialsasync_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_authlistener, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_credentials, void*);
    using alljoyn_authlistener_securityviolation_ptr = void __stdcall(void*, Windows::Win32::Devices::AllJoyn::QStatus, Windows::Win32::Devices::AllJoyn::alljoyn_message);
    using alljoyn_authlistener_authenticationcomplete_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, int32_t);
    using alljoyn_buslistener_listener_registered_ptr = void __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_busattachment);
    using alljoyn_buslistener_listener_unregistered_ptr = void __stdcall(void*);
    using alljoyn_buslistener_found_advertised_name_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, uint16_t, Windows::Win32::Foundation::PSTR);
    using alljoyn_buslistener_lost_advertised_name_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, uint16_t, Windows::Win32::Foundation::PSTR);
    using alljoyn_buslistener_name_owner_changed_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR);
    using alljoyn_buslistener_bus_stopping_ptr = void __stdcall(void*);
    using alljoyn_buslistener_bus_disconnected_ptr = void __stdcall(void*);
    using alljoyn_buslistener_bus_prop_changed_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg);
    using alljoyn_interfacedescription_translation_callback_ptr = Windows::Win32::Foundation::PSTR __stdcall(Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR);
    using alljoyn_messagereceiver_methodhandler_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::alljoyn_busobject, Windows::Win32::Devices::AllJoyn::alljoyn_interfacedescription_member*, Windows::Win32::Devices::AllJoyn::alljoyn_message);
    using alljoyn_messagereceiver_replyhandler_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::alljoyn_message, void*);
    using alljoyn_messagereceiver_signalhandler_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::alljoyn_interfacedescription_member*, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_message);
    using alljoyn_busobject_prop_get_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg);
    using alljoyn_busobject_prop_set_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg);
    using alljoyn_busobject_object_registration_ptr = void __stdcall(void*);
    using alljoyn_proxybusobject_listener_introspectcb_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::QStatus, Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject, void*);
    using alljoyn_proxybusobject_listener_getpropertycb_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::QStatus, Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg, void*);
    using alljoyn_proxybusobject_listener_getallpropertiescb_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::QStatus, Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg, void*);
    using alljoyn_proxybusobject_listener_setpropertycb_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::QStatus, Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject, void*);
    using alljoyn_proxybusobject_listener_propertieschanged_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg, void*);
    using alljoyn_permissionconfigurationlistener_factoryreset_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*);
    using alljoyn_permissionconfigurationlistener_policychanged_ptr = void __stdcall(void*);
    using alljoyn_permissionconfigurationlistener_startmanagement_ptr = void __stdcall(void*);
    using alljoyn_permissionconfigurationlistener_endmanagement_ptr = void __stdcall(void*);
    using alljoyn_sessionlistener_sessionlost_ptr = void __stdcall(void*, uint32_t, Windows::Win32::Devices::AllJoyn::alljoyn_sessionlostreason);
    using alljoyn_sessionlistener_sessionmemberadded_ptr = void __stdcall(void*, uint32_t, Windows::Win32::Foundation::PSTR);
    using alljoyn_sessionlistener_sessionmemberremoved_ptr = void __stdcall(void*, uint32_t, Windows::Win32::Foundation::PSTR);
    using alljoyn_sessionportlistener_acceptsessionjoiner_ptr = int32_t __stdcall(void*, uint16_t, Windows::Win32::Foundation::PSTR, Windows::Win32::Devices::AllJoyn::alljoyn_sessionopts);
    using alljoyn_sessionportlistener_sessionjoined_ptr = void __stdcall(void*, uint16_t, uint32_t, Windows::Win32::Foundation::PSTR);
    using alljoyn_about_announced_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, uint16_t, uint16_t, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg);
    using alljoyn_busattachment_joinsessioncb_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::QStatus, uint32_t, Windows::Win32::Devices::AllJoyn::alljoyn_sessionopts, void*);
    using alljoyn_busattachment_setlinktimeoutcb_ptr = void __stdcall(Windows::Win32::Devices::AllJoyn::QStatus, uint32_t, void*);
    using alljoyn_aboutdatalistener_getaboutdata_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg, Windows::Win32::Foundation::PSTR);
    using alljoyn_aboutdatalistener_getannouncedaboutdata_ptr = Windows::Win32::Devices::AllJoyn::QStatus __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_msgarg);
    using alljoyn_autopinger_destination_lost_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR);
    using alljoyn_autopinger_destination_found_ptr = void __stdcall(void*, Windows::Win32::Foundation::PSTR, Windows::Win32::Foundation::PSTR);
    using alljoyn_observer_object_discovered_ptr = void __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject_ref);
    using alljoyn_observer_object_lost_ptr = void __stdcall(void*, Windows::Win32::Devices::AllJoyn::alljoyn_proxybusobject_ref);
