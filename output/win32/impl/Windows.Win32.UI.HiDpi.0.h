...
#ifndef WIN32_Windows_Win32_UI_HiDpi_0_H
#define WIN32_Windows_Win32_UI_HiDpi_0_H
WIN32_EXPORT namespace win32::Windows::Win32::UI::HiDpi
{
#pragma region enums
    enum class DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS : uint32_t
    {
        DCDC_DEFAULT = 0x0,
        DCDC_DISABLE_FONT_UPDATE = 0x1,
        DCDC_DISABLE_RELAYOUT = 0x2,
    };
    enum class DIALOG_DPI_CHANGE_BEHAVIORS : uint32_t
    {
        DDC_DEFAULT = 0x0,
        DDC_DISABLE_ALL = 0x1,
