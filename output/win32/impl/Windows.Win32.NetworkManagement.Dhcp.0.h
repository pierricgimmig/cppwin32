...
#ifndef WIN32_Windows_Win32_NetworkManagement_Dhcp_0_H
#define WIN32_Windows_Win32_NetworkManagement_Dhcp_0_H
...
#pragma region delegates
    ...
    using LPDHCP_HANDLE_OPTIONS = uint32_t __stdcall(uint8_t*, uint32_t, void*, void*, Windows::Win32::NetworkManagement::Dhcp::DHCP_SERVER_OPTIONS*);
    using LPDHCP_DELETE_CLIENT = uint32_t __stdcall(uint32_t, uint8_t*, uint32_t, uint32_t, uint32_t);
    using LPDHCP_ENTRY_POINT_FUNC = uint32_t __stdcall(Windows::Win32::Foundation::PWSTR, uint32_t, Windows::Win32::NetworkManagement::Dhcp::DHCP_CALLOUT_TABLE*);
