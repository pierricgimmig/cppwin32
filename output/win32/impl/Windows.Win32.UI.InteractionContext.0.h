...
#ifndef WIN32_Windows_Win32_UI_InteractionContext_0_H
#define WIN32_Windows_Win32_UI_InteractionContext_0_H
WIN32_EXPORT namespace win32::Windows::Win32::UI::InteractionContext
{
#pragma region enums
    enum class CROSS_SLIDE_FLAGS : uint32_t
    {
        CROSS_SLIDE_FLAGS_NONE = 0x0,
        CROSS_SLIDE_FLAGS_SELECT = 0x1,
        CROSS_SLIDE_FLAGS_SPEED_BUMP = 0x2,
        CROSS_SLIDE_FLAGS_REARRANGE = 0x4,
    ...
    enum class INTERACTION_CONFIGURATION_FLAGS : uint32_t
    {
        INTERACTION_CONFIGURATION_FLAG_NONE = 0x0,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION = 0x1,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_X = 0x2,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_Y = 0x4,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_ROTATION = 0x8,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_SCALING = 0x10,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_INERTIA = 0x20,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_ROTATION_INERTIA = 0x40,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_SCALING_INERTIA = 0x80,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_RAILS_X = 0x100,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_RAILS_Y = 0x200,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_EXACT = 0x400,
        INTERACTION_CONFIGURATION_FLAG_MANIPULATION_MULTIPLE_FINGER_PANNING = 0x800,
        INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE = 0x1,
        INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_HORIZONTAL = 0x2,
        INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_SELECT = 0x4,
        INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_SPEED_BUMP = 0x8,
        INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_REARRANGE = 0x10,
        INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_EXACT = 0x20,
        INTERACTION_CONFIGURATION_FLAG_TAP = 0x1,
        INTERACTION_CONFIGURATION_FLAG_TAP_DOUBLE = 0x2,
        INTERACTION_CONFIGURATION_FLAG_TAP_MULTIPLE_FINGER = 0x4,
        INTERACTION_CONFIGURATION_FLAG_SECONDARY_TAP = 0x1,
        INTERACTION_CONFIGURATION_FLAG_HOLD = 0x1,
        INTERACTION_CONFIGURATION_FLAG_HOLD_MOUSE = 0x2,
        INTERACTION_CONFIGURATION_FLAG_HOLD_MULTIPLE_FINGER = 0x4,
        INTERACTION_CONFIGURATION_FLAG_DRAG = 0x1,
    ...
    enum class INTERACTION_FLAGS : uint32_t
    {
        INTERACTION_FLAG_NONE = 0x0,
        INTERACTION_FLAG_BEGIN = 0x1,
        INTERACTION_FLAG_END = 0x2,
        INTERACTION_FLAG_CANCEL = 0x4,
        INTERACTION_FLAG_INERTIA = 0x8,
...
#pragma region delegates
    using INTERACTION_CONTEXT_OUTPUT_CALLBACK = void __stdcall(void*, Windows::Win32::UI::InteractionContext::INTERACTION_CONTEXT_OUTPUT*);
    using INTERACTION_CONTEXT_OUTPUT_CALLBACK2 = void __stdcall(void*, Windows::Win32::UI::InteractionContext::INTERACTION_CONTEXT_OUTPUT2*);
