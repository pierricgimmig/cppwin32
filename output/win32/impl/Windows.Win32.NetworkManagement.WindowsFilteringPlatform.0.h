...
#ifndef WIN32_Windows_Win32_NetworkManagement_WindowsFilteringPlatform_0_H
#define WIN32_Windows_Win32_NetworkManagement_WindowsFilteringPlatform_0_H
...
#pragma region enums
    ...
    enum class FWPM_FILTER_FLAGS : uint32_t
    {
        FWPM_FILTER_FLAG_NONE = 0x0,
        FWPM_FILTER_FLAG_PERSISTENT = 0x1,
        FWPM_FILTER_FLAG_BOOTTIME = 0x2,
        FWPM_FILTER_FLAG_HAS_PROVIDER_CONTEXT = 0x4,
        FWPM_FILTER_FLAG_CLEAR_ACTION_RIGHT = 0x8,
        FWPM_FILTER_FLAG_PERMIT_IF_CALLOUT_UNREGISTERED = 0x10,
        FWPM_FILTER_FLAG_DISABLED = 0x20,
        FWPM_FILTER_FLAG_INDEXED = 0x40,
    };
    ...
    enum class FWPM_SUBSCRIPTION_FLAGS : uint32_t
    {
        FWPM_SUBSCRIPTION_FLAG_NOTIFY_ON_ADD = 0x1,
        FWPM_SUBSCRIPTION_FLAG_NOTIFY_ON_DELETE = 0x2,
    };
    ...
    enum class IKEEXT_CERT_AUTH : uint32_t
    {
        IKEEXT_CERT_AUTH_FLAG_SSL_ONE_WAY = 0x1,
        IKEEXT_CERT_AUTH_ENABLE_CRL_CHECK_STRONG = 0x4,
        IKEEXT_CERT_AUTH_DISABLE_SSL_CERT_VALIDATION = 0x8,
        IKEEXT_CERT_AUTH_ALLOW_HTTP_CERT_LOOKUP = 0x10,
        IKEEXT_CERT_AUTH_URL_CONTAINS_BUNDLE = 0x20,
    };
    ...
    enum class IKEEXT_CERT_FLAGS : uint32_t
    {
        IKEEXT_CERT_FLAG_ENABLE_ACCOUNT_MAPPING = 0x1,
        IKEEXT_CERT_FLAG_DISABLE_REQUEST_PAYLOAD = 0x2,
        IKEEXT_CERT_FLAG_USE_NAP_CERTIFICATE = 0x4,
        IKEEXT_CERT_FLAG_INTERMEDIATE_CA = 0x8,
        IKEEXT_CERT_FLAG_IGNORE_INIT_CERT_MAP_FAILURE = 0x10,
        IKEEXT_CERT_FLAG_PREFER_NAP_CERTIFICATE_OUTBOUND = 0x20,
        IKEEXT_CERT_FLAG_SELECT_NAP_CERTIFICATE = 0x40,
        IKEEXT_CERT_FLAG_VERIFY_NAP_CERTIFICATE = 0x80,
        IKEEXT_CERT_FLAG_FOLLOW_RENEWAL_CERTIFICATE = 0x100,
    };
    ...
    enum class IKEEXT_EAP_AUTHENTICATION_FLAGS : uint32_t
    {
        IKEEXT_EAP_FLAG_LOCAL_AUTH_ONLY = 0x1,
        IKEEXT_EAP_FLAG_REMOTE_AUTH_ONLY = 0x2,
    };
    ...
    enum class IKEEXT_KERBEROS_AUTHENTICATION_FLAGS : uint32_t
    {
        IKEEXT_KERB_AUTH_DISABLE_INITIATOR_TOKEN_GENERATION = 0x1,
        IKEEXT_KERB_AUTH_DONT_ACCEPT_EXPLICIT_CREDENTIALS = 0x2,
    };
    ...
    enum class IKEEXT_POLICY_FLAG : uint32_t
    {
        IKEEXT_POLICY_FLAG_DISABLE_DIAGNOSTICS = 0x1,
        IKEEXT_POLICY_FLAG_NO_MACHINE_LUID_VERIFY = 0x2,
        IKEEXT_POLICY_FLAG_NO_IMPERSONATION_LUID_VERIFY = 0x4,
        IKEEXT_POLICY_FLAG_ENABLE_OPTIONAL_DH = 0x8,
    };
    enum class IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS : uint32_t
    {
        IKEEXT_PSK_FLAG_LOCAL_AUTH_ONLY = 0x1,
        IKEEXT_PSK_FLAG_REMOTE_AUTH_ONLY = 0x2,
    };
    ...
    enum class IKEEXT_RESERVED_AUTHENTICATION_FLAGS : uint32_t
    {
        IKEEXT_RESERVED_AUTH_DISABLE_INITIATOR_TOKEN_GENERATION = 0x1,
    };
    ...
    enum class IPSEC_DOSP_FLAGS : uint32_t
    {
        IPSEC_DOSP_FLAG_ENABLE_IKEV1 = 0x1,
        IPSEC_DOSP_FLAG_ENABLE_IKEV2 = 0x2,
        IPSEC_DOSP_FLAG_DISABLE_AUTHIP = 0x4,
        IPSEC_DOSP_FLAG_DISABLE_DEFAULT_BLOCK = 0x8,
        IPSEC_DOSP_FLAG_FILTER_BLOCK = 0x10,
        IPSEC_DOSP_FLAG_FILTER_EXEMPT = 0x20,
    };
    ...
    enum class IPSEC_POLICY_FLAG : uint32_t
    {
        IPSEC_POLICY_FLAG_ND_SECURE = 0x2,
        IPSEC_POLICY_FLAG_ND_BOUNDARY = 0x4,
        IPSEC_POLICY_FLAG_NAT_ENCAP_ALLOW_PEER_BEHIND_NAT = 0x10,
        IPSEC_POLICY_FLAG_NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL = 0x20,
        IPSEC_POLICY_FLAG_DONT_NEGOTIATE_SECOND_LIFETIME = 0x40,
        IPSEC_POLICY_FLAG_DONT_NEGOTIATE_BYTE_LIFETIME = 0x80,
        IPSEC_POLICY_FLAG_CLEAR_DF_ON_TUNNEL = 0x8,
        IPSEC_POLICY_FLAG_ENABLE_V6_IN_V4_TUNNELING = 0x100,
        IPSEC_POLICY_FLAG_ENABLE_SERVER_ADDR_ASSIGNMENT = 0x200,
        IPSEC_POLICY_FLAG_TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION = 0x400,
        IPSEC_POLICY_FLAG_TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION = 0x800,
        IPSEC_POLICY_FLAG_TUNNEL_BYPASS_ICMPV6 = 0x1000,
        IPSEC_POLICY_FLAG_KEY_MANAGER_ALLOW_DICTATE_KEY = 0x2000,
    };
    enum class IPSEC_SA_BUNDLE_FLAGS : uint32_t
    {
        IPSEC_SA_BUNDLE_FLAG_ND_SECURE = 0x1,
        IPSEC_SA_BUNDLE_FLAG_ND_BOUNDARY = 0x2,
        IPSEC_SA_BUNDLE_FLAG_ND_PEER_NAT_BOUNDARY = 0x4,
        IPSEC_SA_BUNDLE_FLAG_GUARANTEE_ENCRYPTION = 0x8,
        IPSEC_SA_BUNDLE_FLAG_ALLOW_NULL_TARGET_NAME_MATCH = 0x200,
        IPSEC_SA_BUNDLE_FLAG_CLEAR_DF_ON_TUNNEL = 0x400,
        IPSEC_SA_BUNDLE_FLAG_ASSUME_UDP_CONTEXT_OUTBOUND = 0x800,
        IPSEC_SA_BUNDLE_FLAG_ND_PEER_BOUNDARY = 0x1000,
        IPSEC_SA_BUNDLE_FLAG_SUPPRESS_DUPLICATE_DELETION = 0x2000,
        IPSEC_SA_BUNDLE_FLAG_PEER_SUPPORTS_GUARANTEE_ENCRYPTION = 0x4000,
    };
...
#pragma region delegates
    using FWPM_PROVIDER_CHANGE_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_PROVIDER_CHANGE0*);
    using FWPM_PROVIDER_CONTEXT_CHANGE_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_PROVIDER_CONTEXT_CHANGE0*);
    using FWPM_SUBLAYER_CHANGE_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_SUBLAYER_CHANGE0*);
    using FWPM_CALLOUT_CHANGE_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_CALLOUT_CHANGE0*);
    using FWPM_FILTER_CHANGE_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_FILTER_CHANGE0*);
    using IPSEC_SA_CONTEXT_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::IPSEC_SA_CONTEXT_CHANGE0*);
    using IPSEC_KEY_MANAGER_KEY_DICTATION_CHECK0 = void __stdcall(Windows::Win32::NetworkManagement::WindowsFilteringPlatform::IKEEXT_TRAFFIC0*, Windows::Win32::Foundation::BOOL*, uint32_t*);
    using IPSEC_KEY_MANAGER_DICTATE_KEY0 = uint32_t __stdcall(Windows::Win32::NetworkManagement::WindowsFilteringPlatform::IPSEC_SA_DETAILS1*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::IPSEC_SA_DETAILS1*, Windows::Win32::Foundation::BOOL*);
    using IPSEC_KEY_MANAGER_NOTIFY_KEY0 = void __stdcall(Windows::Win32::NetworkManagement::WindowsFilteringPlatform::IPSEC_SA_DETAILS1*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::IPSEC_SA_DETAILS1*);
    using FWPM_NET_EVENT_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_NET_EVENT1*);
    using FWPM_NET_EVENT_CALLBACK1 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_NET_EVENT2*);
    using FWPM_NET_EVENT_CALLBACK2 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_NET_EVENT3*);
    using FWPM_NET_EVENT_CALLBACK3 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_NET_EVENT4_*);
    using FWPM_NET_EVENT_CALLBACK4 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_NET_EVENT5_*);
    using FWPM_DYNAMIC_KEYWORD_CALLBACK0 = void __stdcall(void*, void*);
    using FWPM_SYSTEM_PORTS_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_SYSTEM_PORTS0*);
    using FWPM_CONNECTION_CALLBACK0 = void __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_CONNECTION_EVENT_TYPE, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_CONNECTION0*);
    using FWPM_VSWITCH_EVENT_CALLBACK0 = uint32_t __stdcall(void*, Windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWPM_VSWITCH_EVENT0*);
