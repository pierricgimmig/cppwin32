...
#ifndef WIN32_Windows_Win32_Networking_WebSocket_0_H
#define WIN32_Windows_Win32_Networking_WebSocket_0_H
WIN32_EXPORT namespace win32::Windows::Win32::Networking::WebSocket
{
#pragma region enums
    enum class WEB_SOCKET_ACTION : int32_t
    {
    ...
    enum class WEB_SOCKET_CLOSE_STATUS : int32_t
    {
    ...
    enum class WEB_SOCKET_PROPERTY_TYPE : int32_t
    {
