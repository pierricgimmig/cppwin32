...
#ifndef WIN32_Windows_Win32_Networking_HttpServer_0_H
#define WIN32_Windows_Win32_Networking_HttpServer_0_H
...
#pragma region enums
    ...
    enum class HTTP_CREATE_REQUEST_QUEUE_PROPERTY_ID : int32_t
    {
    ...
    enum class HTTP_FEATURE_ID : int32_t
    {
    ...
    enum class HTTP_INITIALIZE : uint32_t
    {
        HTTP_INITIALIZE_CONFIG = 0x2,
        HTTP_INITIALIZE_SERVER = 0x1,
    };
    ...
    enum class HTTP_PERFORMANCE_PARAM_TYPE : int32_t
    {
    ...
    enum class HTTP_RECEIVE_HTTP_REQUEST_FLAGS : uint32_t
    {
        HTTP_RECEIVE_REQUEST_FLAG_COPY_BODY = 0x1,
        HTTP_RECEIVE_REQUEST_FLAG_FLUSH_BODY = 0x2,
    };
    ...
    enum class HTTP_SCHEME : int32_t
    {
        HttpSchemeHttp = 0,
        HttpSchemeHttps = 1,
        HttpSchemeMaximum = 2,
