...
#ifndef WIN32_Windows_Win32_NetworkManagement_WindowsConnectNow_0_H
#define WIN32_Windows_Win32_NetworkManagement_WindowsConnectNow_0_H
WIN32_EXPORT namespace win32::Windows::Win32::NetworkManagement::WindowsConnectNow
{
#pragma region enums
    enum class WCN_ATTRIBUTE_TYPE : int32_t
    {
    ...
    enum class WCN_PASSWORD_TYPE : int32_t
    {
    ...
    enum class WCN_VALUE_TYPE_AUTHENTICATION_TYPE : int32_t
    {
        WCN_VALUE_AT_OPEN = 1,
    ...
    enum class WCN_VALUE_TYPE_BOOLEAN : int32_t
    {
        WCN_VALUE_FALSE = 0,
        WCN_VALUE_TRUE = 1,
    };
    enum class WCN_VALUE_TYPE_CONFIGURATION_ERROR : int32_t
    {
    ...
    enum class WCN_VALUE_TYPE_CONFIG_METHODS : int32_t
    {
        WCN_VALUE_CM_USBA = 1,
    ...
    enum class WCN_VALUE_TYPE_CONNECTION_TYPE : int32_t
    {
        WCN_VALUE_CT_ESS = 1,
        WCN_VALUE_CT_IBSS = 2,
    };
    enum class WCN_VALUE_TYPE_DEVICE_PASSWORD_ID : int32_t
    {
    ...
    enum class WCN_VALUE_TYPE_ENCRYPTION_TYPE : int32_t
    {
        WCN_VALUE_ET_NONE = 1,
        WCN_VALUE_ET_WEP = 2,
        WCN_VALUE_ET_TKIP = 4,
    ...
    enum class WCN_VALUE_TYPE_MESSAGE_TYPE : int32_t
    {
    ...
    enum class WCN_VALUE_TYPE_REQUEST_TYPE : int32_t
    {
    ...
    enum class WCN_VALUE_TYPE_RESPONSE_TYPE : int32_t
    {
    ...
    enum class WCN_VALUE_TYPE_RF_BANDS : int32_t
    {
        WCN_VALUE_RB_24GHZ = 1,
        WCN_VALUE_RB_50GHZ = 2,
    };
    enum class WCN_VALUE_TYPE_VERSION : int32_t
    {
        WCN_VALUE_VERSION_1_0 = 16,
        WCN_VALUE_VERSION_2_0 = 32,
    };
    enum class WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE : int32_t
    {
