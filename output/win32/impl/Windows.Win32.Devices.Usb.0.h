...
#ifndef WIN32_Windows_Win32_Devices_Usb_0_H
#define WIN32_Windows_Win32_Devices_Usb_0_H
WIN32_EXPORT namespace win32::Windows::Win32::Devices::Usb
{
#pragma region enums
    enum class PIPE_TYPE : int32_t
    {
        EVENT_PIPE = 0,
        READ_DATA_PIPE = 1,
        WRITE_DATA_PIPE = 2,
    ...
    enum class RAW_PIPE_TYPE : int32_t
    {
    ...
    enum class USBFN_BUS_SPEED : int32_t
    {
        UsbfnBusSpeedLow = 0,
        UsbfnBusSpeedFull = 1,
        UsbfnBusSpeedHigh = 2,
    ...
    enum class USBFN_DEVICE_STATE : int32_t
    {
    ...
    enum class USBFN_DIRECTION : int32_t
    {
    ...
    enum class USBFN_EVENT : int32_t
    {
        UsbfnEventMinimum = 0,
        UsbfnEventAttach = 1,
        UsbfnEventReset = 2,
    ...
    enum class USBFN_PORT_TYPE : int32_t
    {
        UsbfnUnknownPort = 0,
