...
#ifndef WIN32_Windows_Win32_System_EventLog_0_H
#define WIN32_Windows_Win32_System_EventLog_0_H
...
#pragma region enums
    ...
    enum class READ_EVENT_LOG_READ_FLAGS : uint32_t
    {
        EVENTLOG_SEEK_READ = 0x2,
        EVENTLOG_SEQUENTIAL_READ = 0x1,
    };
    enum class REPORT_EVENT_TYPE : uint16_t
    {
...
#pragma region delegates
    using EVT_SUBSCRIBE_CALLBACK = uint32_t __stdcall(Windows::Win32::System::EventLog::EVT_SUBSCRIBE_NOTIFY_ACTION, void*, intptr_t);
